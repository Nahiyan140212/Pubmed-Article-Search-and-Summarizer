...
with st.sidebar:
    ...
    with st.form(key='search_form'):
        ...
        author = st.text_input("Author Name", placeholder="optional: Avoid for the best result")
        journal = st.text_input("Journal Name", placeholder="optional: Avoid for the best result")
